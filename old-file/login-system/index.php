...
<html lang="en">
  ...
  <body>
     <div class="container">
       <div class="info">
         <h2 class="bg-primary">Student Council Online Voting System</h2>
        <!-- <div class="bg-info">
       ...
       <center>  <p><img src="vsc/Vsource/gic_logo1.png" class ="img-rounded" alt = "Cinque Terre" width ="396" height="158" align-center></center></p>
