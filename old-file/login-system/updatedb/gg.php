...
{
    $data = getPosts();
    $insert_Query = "INSERT INTO `users`(`fname`, `lname`, `age`, `Party`,`Position`) VALUES ('$data[1]','$data[2]',$data[3],'$data[4]','$data[5]')";
    try{
...
<html>
    ...
    <body>
        <form action="gg.php" method="post">
            ...
            <input type="text" name="Party" placeholder="Party" value ="<?php echo $Party;?>"><br><br>
